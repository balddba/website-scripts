"""Render complete MySQL script results as a self-contained HTML report."""
...
def render_html(entries: list[ScriptReportEntry]) -> str:
    ...
    if not sections:
        sections = "<p><strong>No MySQL scripts were executed.</strong> Check the pytest skip reasons and MYSQL_TEST_* settings.</p>"
    return f"""<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>MySQL script test report</title>
  <style>
...
<body>
  <h1>MySQL script test report</h1>
