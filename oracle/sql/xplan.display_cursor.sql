/*******************************************************************************
*
* Script Name: xplan.display_cursor.sql
* Title: XPLAN cursor display wrapper
* Tags: SQL, Plans
* Purpose: Wrapper over DBMS_XPLAN.DISPLAY_CURSOR that adds parent ID and order columns
*
* Description:
...
* Parameters:
*   &1 - (Optional) SQL_ID
*   &2 - (Optional) Child number
*   &3 - (Optional) Plan format
*
* Required Privileges:
*   - SELECT on V$SQL_PLAN / related cursor views
*   - Execute DBMS_XPLAN
*
* Output Format:
