/*******************************************************************************
*
* Script Name: xplan.package.sql
* Title: XPLAN package
* Tags: SQL, Plans
* Purpose: Create the XPLAN package wrapper over DBMS_XPLAN with parent ID and order columns
*
* Description:
*   Third-party utility by Adrian Billington (oracle-developer.net). Cataloged
*   here for the balddba.com script library. Original header follows. Provides
*   DISPLAY, DISPLAY_CURSOR, and optional DISPLAY_AWR wrappers.
*
* Parameters:
*   None.
*
...
*
* Output Format:
*   - Creates the XPLAN package. Plan output includes Id, PID, and Order.
*
* Example Usage:
*   @xplan.package.sql
*
