/*******************************************************************************
*
* Script Name: xplan.display_awr.sql
* Title: XPLAN AWR display wrapper
* Tags: SQL, Plans, AWR
* Purpose: Wrapper over DBMS_XPLAN.DISPLAY_AWR that adds parent ID and order columns
*
* Description:
*   Third-party utility by Adrian Billington (oracle-developer.net). Cataloged
*   here for the balddba.com script library. Original header follows.
*
* Parameters:
*   &1 - (Required) SQL_ID
*   &2 - (Optional) Plan hash value
*   &3 - (Optional) Plan format
*
* Required Privileges:
*   - SELECT on AWR views used by DBMS_XPLAN.DISPLAY_AWR
*   - Diagnostic Pack license where required
*
* Output Format:
*   - Execution plan with Id, Pid, Ord, Operation, and Name
*
* Example Usage:
*   @xplan.display_awr.sql <sql_id>
*
* Original Author: Adrian Billington (www.oracle-developer.net)
