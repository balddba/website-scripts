/*******************************************************************************
*
* Script Name: xplan.display.sql
* Title: XPLAN display wrapper
* Tags: SQL, Plans
* Purpose: Wrapper over DBMS_XPLAN.DISPLAY that adds parent ID and order columns
*
* Description:
...
*
* Parameters:
*   &1 - (Optional) Plan table. Default: PLAN_TABLE
*   &2 - (Optional) Statement ID. Default: NULL
*   &3 - (Optional) Plan format. Default: TYPICAL
*
* Required Privileges:
*   - SELECT on the plan table
*   - Execute DBMS_XPLAN
*
* Output Format:
